...
export const PLAYER_LIST_PLAYER_TRANSACTIONS_REQUEST = 'PLAYER_LIST_PLAYER_TRANSACTIONS_REQUEST'
export const PLAYER_LIST_PLAYER_TRANSACTIONS_SUCCESS = 'PLAYER_LIST_PLAYER_TRANSACTIONS_SUCCESS'
export const PLAYER_LIST_PLAYER_TRANSACTIONS_FAIL = 'PLAYER_LIST_PLAYER_TRANSACTIONS_FAIL'

export const PLAYER_LIST_ROOM_TRANSACTIONS_REQUEST = 'PLAYER_LIST_ROOM_TRANSACTIONS_REQUEST'
export const PLAYER_LIST_ROOM_TRANSACTIONS_SUCCESS = 'PLAYER_LIST_ROOM_TRANSACTIONS_SUCCESS'
export const PLAYER_LIST_ROOM_TRANSACTIONS_FAIL = 'PLAYER_LIST_ROOM_TRANSACTIONS_FAIL'
